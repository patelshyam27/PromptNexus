        ...
        <div className="hidden md:flex w-[60%] bg-slate-900 items-center justify-center p-10 border-r border-slate-800 relative group overflow-y-auto custom-scrollbar">
          ...
          {prompt.imageUrl ? (
            <div className="absolute inset-0 z-0 bg-slate-900">
              <img src={contentToProxiedImageUrl(prompt.imageUrl)} alt="Prompt Result" className="w-full h-full object-cover opacity-40 blur-sm" />
      ...
      <div className="w-full md:w-[40%] bg-slate-950 flex flex-col h-full">
        ...
        <div className="flex-1 p-4 overflow-y-auto custom-scrollbar">
          ...
          <div className="md:hidden bg-slate-900 p-4 rounded-lg mb-6 border border-slate-800">
            ...
            {prompt.imageUrl && (
              <div className="mb-4 rounded-lg overflow-hidden border border-slate-800 relative">
                <img src={contentToProxiedImageUrl(prompt.imageUrl)} alt="Result" className="w-full object-cover max-h-60" />
                <a href={prompt.imageUrl} target="_blank" rel="noreferrer" className="absolute top-2 right-2 bg-black/60 hover:bg-black/80 text-white p-1.5 rounded-lg">
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950 shrink-0 z-10">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={handleCopy}
              className={`flex-1 py-3 rounded-lg font-semibold text-sm transition-all flex items-center justify-center gap-2 ${copied
